...
(function($) {
	...
	skel.init({
		reset: 'full',
		breakpoints: {
			global:		{ range: '*', href: style, containers: 1400, grid: { gutters: 50 } },
			wide:		{ range: '-1680', href: wideStyle, containers: 1200, grid: { gutters: 40 } },
			normal:		{ range: '-1280', href: normalStyle, containers: 960, viewport: { scalable: false } },
			narrow:		{ range: '-980', href: narrowStyle, containers: '95%', grid: { gutters: 30 } },
			narrower:	{ range: '-840', href: narrowerStyle, containers: '95%!' },
			mobile:		{ range: '-736', href: mobileStyle, containers: '100%!' }
		},
		plugins: {
			layers: {
				config: {
